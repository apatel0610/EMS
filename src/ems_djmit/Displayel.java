...
import static ems_djmit.Displayws.t1;
...
public class Displayel extends JDialog {
...
public static Vector rows() {
    ...
    if(!(t1.equals("")))
		...
		Statement ss=con.createStatement();
                ...
                String querry="select * from expl where ID = '"+t1+"' ";
    ...
    if(!(t2.equals("")))
		...
		Statement ss=con.createStatement();
                ...
                String querry="select * from expl where Title = '"+t2+"' ";
                rset = ss.executeQuery(querry);
		...
		Statement ss=con.createStatement();
                ...
                String querry="select * from expl where Experter_Name = '"+t3+"' ";
                rset = ss.executeQuery(querry);
		...
		Statement ss=con.createStatement();
                ...
                String querry="select * from expl where Date = '"+t4+"' ";
                rset = ss.executeQuery(querry);
		...
		Statement ss=con.createStatement();
                ...
                String querry="select * from expl where Department = '"+t5+"' ";
                rset = ss.executeQuery(querry);
...
public static void main(String args[]) {
    try {
        ...
        Displayel dialog = new Displayel(null,null,null,null,null);
  ...
  Displayel(String a,String b,String c,String d,String e) {
    super();
...
//    getContentPane().add(TableLabel);
    ...
    btn.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent arg0) {
            Expert_lecture rp=new Expert_lecture();
            rp.setVisible(true);
            setVisible(false);
            dispose();
        }
