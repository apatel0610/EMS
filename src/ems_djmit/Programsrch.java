 ...
 * @author ASUS
 */
public class Programsrch extends javax.swing.JFrame {

    /**
     * Creates new form evnts
     */
    public Programsrch() throws SQLException, ClassNotFoundException {
        initComponents(); 
        {
            ...
            String querry="select ID from pg";
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Type Of Progrsm :");
        ...
        title.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Program" }));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        String mystr3=toe.getSelectedItem().toString();
        String mystr4=day.getSelectedItem().toString()+"-"+month.getSelectedItem().toString()+"-"+year.getSelectedItem().toString();
      ...
      /*  if(mystr1.equals("Select ID"))
        ...
        if(mystr2.equals("Select Program") )
            {
                title.setBackground(Color.red);
                disp.setText("Title Field cannot be left empty");
            }
        
        if(mystr3.equals("Select Type") )
            {
        ...
        if(mystr4.equals("Day-Month-Year") )
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Programsrch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Programsrch().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Programsrch.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Programsrch.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
