      ...
      //  String s12=year.getSelectedItem().toString();
        ...
        try
        {
            ...
            else
            {
                ...
                String querry="insert into ws(ID,Title,Faculty_Name,Department,No_of_students,Institute,Description,Venue,Date,Durations)values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"')";
