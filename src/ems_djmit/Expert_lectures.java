 ...
 * @author ASUS
 */
public class Expert_lectures extends javax.swing.JFrame {

    /**
     * Creates new form expert_letures
     */
    public Expert_lectures() throws SQLException, ClassNotFoundException {
        initComponents(); 
        {
            ...
            String querry="select ID from expl";
        ...
        
        {
            ...
            String querry="select Title from expl";
            rset = ss.executeQuery(querry);
            ResultSetMetaData md = rset.getMetaData();
            int columns = md.getColumnCount();
        ...
        }      
        {
            ...
            String querry="select Experter_name from expl";
            rset = ss.executeQuery(querry);
            ResultSetMetaData md = rset.getMetaData();
            int columns = md.getColumnCount();
    ...
    private void initComponents() {
        ...
        dept.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Mechanical Engineering", "Civil Engineering", "Computer Science & Engineering", "Electronics & Communication Engineering", "Electical Engineering", "Information Technology" }));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        Displayel dp=new Displayel(mystr0,mystr1,mystr2,mystr3,mystr4);
        dp.setVisible(true);
        setVisible(false);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Expert_lectures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Expert_lectures().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Expert_lectures.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Expert_lectures.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
